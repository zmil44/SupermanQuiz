#--------------------------------------------------------------------------
# 
# Script Name: SupermanQuiz_Exercise.rb
# Version:     1.0
...
class Quiz
  ...
  def display_instructions
    ...
    puts "grade will be displayed at the end of the test. If you would like to know "
	puts "about the grading scale press y, if not press n."
	answer = STDIN.gets
	if answer == "y" 
		puts "You will be graded on a scale of 1-10. you must score at least 6 correct"
		puts "to obtain a passing score."
	end
    puts "Good luck!\n\n\n\n\n\n\n\n\n"
  ...
  def determine_grade
    ...
    if $noRight >= 6 then
      ...
      puts "You have earned a rank of: Good Citizen" if $noRight == 8
      ...
      puts "retake the quiz. Or checkout the wikipedia page about the movies"
...
#of correctly answered quiz questions
	...
	loop do
	  ...
	  "a. Walter", "b. Thomas", "c. Jacob", "d. Joseph", 
	  "d")
	  
	  #Call upon the disp_q method and pass it the seventh question
	  SQ.disp_q("What super-villain killed the Man of Steel in Superman #75?",
	  "a. Brainiac", "b. Lex Luthor", "c. Darkseid", "d. Doomsday", 
	  "d")
	  
	  #Call upon the disp_q method and pass it the eigth question
	  SQ.disp_q("Which of Superman's sweethearts became the super-heroine known as Insect Queen?",
	  "a. Lana Lang", "b. Lori Lemaris", "c. Lyla Lerrol", "d. Lois Lane", 
	  "a")
	  
	  #Call upon the disp_q method and pass it the ninth question
	  SQ.disp_q("What is Superman's Kryptonian name?",
	  "a. Zor-el", "b. Jimbo", "c. Kal-el", "d. Jor-el", 
	  "c")
	  
	  #Call upon the disp_q method and pass it the tenth question
	  SQ.disp_q("What was the name of Superman's birth mother?",
	  "a. Xala", "b. Faora", "c. Kara", "d. Lara", 
	  "d")
